...
$("#ingreso").submit(function (e) {
        ...
        var psw = $("#id-password").val();        

        var dataString = 'email=' + email + '&psw=' + psw;
        ...
        if (isValidEmail(email) && (psw.length > 1)) {            
...
=================================== 
    ...
    $("#registro").submit(function (e) {
        ...
        var promo = $("#rf-promo").val();

        var email = $("#rf-email").val();        

        var dataString = 'promo=' + promo + '&email=' + email;
        ...
        if (isValidEmail(email) && (promo.length > 1)) {            
            ...
            $.ajax({
                ...
                success: function (data) {                    
                    ...
                    if(data==1){
                        ...
                        $('.subscription-success').html('<span class="icon_check_alt2"></span> Tus cr&eacute;ditos han sido registrados satisfactoriamente, gracias por ser parte de nuestra exclusiva comunidad.').fadeIn(1000);

                        $('.subscription-error').fadeOut(500);     

                    }   else if(data==0) {

                        $('.subscription-error').html('<span class="icon_close_alt2"></span> No hemos registrado tus cr&eacute;ditos, el c&oacute;digo no es v&aacute;lido o ya fue registrado.').fadeIn(1000);
            ...
            $('.subscription-error').html('<span class="icon_close_alt2"></span> Tu e-mail debe ser v&aacute;lido y debes tener un c&oacute;digo de promocí&oacute;n.').fadeIn(1000);
