...
if(!empty($_POST['factura'])){
	...
	$guardar=guardarInteraccion($_SESSION['sesion'], $_POST['idmensaje'], $fechaInt, $_POST['montovlr'], $_POST['factura'], $_POST['rating'], $_POST['rating2'], $_POST['rating3'], $_POST['observaciones']);
