		...
		<div class="navbar navbar-inverse bs-docs-nav navbar-fixed-top sticky-navigation">
			<div class="container">
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="#"><img src="images/logo-dark@2x.png" alt=""></a>
				</div>
				
				<!-- NAVIGATION LINKS -->
				<div class="navbar-collapse collapse" id="landx-navigation">
					<ul class="nav navbar-nav navbar-right main-navigation">
						<li><a href="#home">Reg&iacute;strate</a></li>
						<!--li><a href="#section1">Brief</a></li>
						<li><a href="#section3">Features</a></li>
						<li><a href="#section4">Pricing</a></li-->
						<li><a href="#section5">C&oacute;mo?</a></li>
						<li><a href="#section6">Promociones</a></li>
		...
		<div class="navbar non-sticky">
			...
			<div class="container">
				...
				<ul class="nav navbar-nav navbar-right social-navigation">
                			<li><i style="color:#ffffff"><?php echo $promo;?></i></li>					
				</ul>
	...
	<div class="container">
		...
		<div class="row">			
			...
			<div class="col-md-10 col-md-offset-1 intro-section">
				...
				<p class="sub-heading">
                    ...
                    ¡Reg&iacute;strate con tu email y gana 100 Triboo cr&eacute;ditos ahora mismo!                    
				</p>
			</div>
		...
		<div class="row">
		    <div class="col-md-6 col-md-offset-3">		        
				...
				<button type="submit" class="btn standard-button" id="rf-submit" name="submit">INGRESAR</button>

				<!-- EMAIL INPUT BOX 
				
				<input type="text" name="rf-promo" id="rf-promo" value="<?php echo $idpromo; ?>" placeholder="Tu código de invitación" class="form-control input-box">
				<input type="email" name="rf-email" id="rf-email" placeholder="Tu e-mail" class="form-control input-box">
				
				<!-- SUBSCRIBE BUTTON 
				<button type="submit" class="btn standard-button" id="rf-submit" name="submit">REGISTRAR</button>	-->		
				</form>        
			</div>		        
		    </div>
		</div>        	
...
<div class="container">
	...
	<div class="sub-heading">
		¿Cómo aprovechas las promociones de nuestra exclusiva comunidad?
	</div>
		...
		<div class="col-md-10 col-md-offset-1">
			...
			<div class="video-container">
				...
				<div class="video">
					...
					<iframe width="640" height="360" src="https://www.youtube.com/embed/P3fAfP5aGYM" frameborder="0" allowfullscreen></iframe>
				</div>
...
<div class="container">
	...
	<!-- SECTION HEADING-->
	<h2>Gana m&aacute;s Cr&eacute;ditos Triboo <img src="images/credits.png" /></h2>
	<div class="colored-line">
	</div>
	
	<div class="sub-heading">
		Busca en nuestras campa&ntilde;as, descarga la imagen ampliada  o con tus amigos comparte los bonos y aprovecha estas promociones...
	</div>
	...
	<div class="row screenshots">		
		<div id="screenshots" class="owl-carousel owl-theme">
			...
			<div class="shot">
				<a href="images/screenshots/promos/macako_normal.jpg" data-lightbox-gallery="screenshots-gallery"><img src="images/screenshots/1.jpg" alt="Screenshot"></a>
			</div>
			
			<div class="shot">
				<a href="images/screenshots/promos/pcbit.jpg" data-lightbox-gallery="screenshots-gallery"><img src="images/screenshots/2.jpg" alt="Screenshot"></a>
			</div>
			
			<div class="shot">
				<a href="images/screenshots/promos/masfruta3.jpg" data-lightbox-gallery="screenshots-gallery"><img src="images/screenshots/5.jpg" alt="Screenshot"></a>
			</div>
			
			<div class="shot">
				<a href="images/screenshots/promos/chocodeliciosos.jpg" data-lightbox-gallery="screenshots-gallery"><img src="images/screenshots/7.jpg" alt="Screenshot"></a>
			</div>
			
			<div class="shot">
				<a href="images/screenshots/promos/masfruta1.jpg" data-lightbox-gallery="screenshots-gallery"><img src="images/screenshots/3.jpg" alt="Screenshot"></a>
			</div>
			
			<div class="shot">
				<a href="images/screenshots/promos/shaya.jpg" data-lightbox-gallery="screenshots-gallery"><img src="images/screenshots/6.jpg" alt="Screenshot"></a>
			</div>
			<div class="shot">
				<a href="images/screenshots/promos/masfruta2.jpg" data-lightbox-gallery="screenshots-gallery"><img src="images/screenshots/4.jpg" alt="Screenshot"></a>
			</div>
		</div>
        <!--div align="right">
        Vis&iacute;tanos y ent&eacute;rate de mas promociones<br>
      	<ul class="nav navbar-nav navbar-right social-navigation hidden-xs">
                <li><a href="https://www.facebook.com/e.triboo" target="_blank"><i class="social_facebook_circle"></i></a></li>
                <li><a href="https://twitter.com/ideatriboo" target="_blank"><i class="social_twitter_circle"></i></a></li>
...
<div class="container">	
	<div class="footer-logo">
		<img src="images/logo-dark@2x.png" alt="">
	</div>
