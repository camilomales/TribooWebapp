...
require_once "../controladores/verEventosControlador.php";
                ...
                //echo $hoy;
                  ...
                  <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                        <div class"cols-xs col-sm-3 col-md-6 col-lg-6">
                                ...
                                data-monto="<?php echo $row['valor'];?>">Aprovechar Evento</button><hr>
                        </div>
                  </div><?php
                  endforeach;
