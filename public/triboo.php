...
<html lang="en">
                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu extended logout">
                            ...
                            <li>
                                <a href="cerrarSession.php"><i class="icon_key_alt"></i> Cerrar sesión</a>
                            </li>
                            <li>
  ...
  <div class="modal fade modal" id="modal-aprov-prom" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
